	...
	void Givebackmenu () {
		...
		while(!exit) {
			...
			case 1:
				...
				System.out.println("Devuelto: " + Samsung_galaxy_s9.productname);
			...
			case 2:
				...
				System.out.println("Devuelto: " + Samsung_galaxy_note.productname);
			...
			case 3:
				...
				System.out.println("Devuelto: " + Samsung_tv.productname);
			...
			case 4:
				...
				System.out.println("Devuelto: " + Samsung_speaker.productname);
