	...
	void Stockmenu () {
		...
		while(!exit) {
			...
			case 1:
				...
				System.out.println("Stock: " + Samsung_galaxy_s9.productstock);

				break;
			
			case 2:
				
				System.out.println("Stock: " + Samsung_galaxy_note.productstock);

				break;
			
			case 3:
				
				System.out.println("Stock: " + Samsung_tv.productstock);
				
				break;
					
			case 4:
				
				System.out.println("Stock: " + Samsung_speaker.productstock);
